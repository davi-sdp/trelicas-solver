...
# Nossa pesquisa de mercado

## 1. Objetivo da Pesquisa
Entender o cenário atual de ferramentas de análise estrutural de treliças para entender as lacunas no mercado educacional e profissional, focando em usabilidade e acessibilidade.
...
*   **[TrussAnalysis](https://trussanalysis.com/free) (Web):** Calculadora simples que analise facilmente uma ampla variedade de estilos comuns de treliças predeterminados.
<img src="../imgs/TrussAnalysis.png" alt="drawing" width="500"/>
*   **[CalcForge](https://calcforge.com/1/free-truss-calculator) (Web):** Outra calculadora web de treliças, simples de usar e com ideais semelhantes ao nosso.

    <img src="../imgs/CalcForge.png" alt="drawing" width="500"/>
*   **Calculadoras 100% Mobile:** Aplicativos simples, mas que muitas vezes carecem de uma visualização clara dos diagramas e relatórios.
    * SW Truss: Aplicativo de análise de elementos finitos para a análise de treliças planas estaticamente determinado e indeterminado
    ...
    <img src="../imgs/SWTruss.png" alt="SWTruss" width="200"/>
...
*   Cálculos sem limite estrutural de nenhum tipo (além dos limites físicos).